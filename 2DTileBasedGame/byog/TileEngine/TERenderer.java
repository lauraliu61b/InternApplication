...
public class TERenderer {
    ...
    public void renderFrame(TETile[][] world) {
        ...
        int numYTiles = world[0].length - 3;
        StdDraw.clear(new Color(0, 0, 0));
        Font font = new Font("Monaco", Font.BOLD, TILE_SIZE * 2);
        StdDraw.setFont(font);
        gui.drawFrame(width, height, this.message);
    ...
    public void renderWelcomePage() {
        String line1 = "CS61B: THE GAME";
        String line2 = "New Game (N)";
        String line3 = "Load Game (L)";
        String line4 = "Quit (:Q)";
        StdDraw.clear(new Color(0, 0, 0));
        StdDraw.setPenColor(StdDraw.WHITE);
        Font font = new Font("Monaco", Font.BOLD, TILE_SIZE * 4);
        StdDraw.setFont(font);
        StdDraw.text(width * 1 / 2, height * 3 / 4, line1);
        font = new Font("Monaco", Font.BOLD, TILE_SIZE * 2);
        StdDraw.setFont(font);
        StdDraw.text(width * 1 / 2, height * 1 / 2, line2);
        StdDraw.text(width * 1 / 2, height * 1 / 2 - 2, line3);
        StdDraw.text(width * 1 / 2, height * 1 / 2 - 4, line4);
        StdDraw.show();
        font = new Font("Monaco", Font.BOLD, TILE_SIZE - 2);
        StdDraw.setFont(font);
    }

    public void renderSeedPage(){
        String line = "PLEASE ENTER SEED:";
        StdDraw.clear(new Color(0, 0, 0));
        StdDraw.setPenColor(StdDraw.WHITE);
        Font font = new Font("Monaco", Font.BOLD, TILE_SIZE * 2);
        StdDraw.setFont(font);
        StdDraw.text(width * 1 / 2, height * 1 / 2, line + this.message);
        StdDraw.show();
        font = new Font("Monaco", Font.BOLD, TILE_SIZE - 2);
        StdDraw.setFont(font);
    }

    public void helpGetMessage(String s) {
        this.message = s;
    }
}
